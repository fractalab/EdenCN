describe("Inductions", () => {
    ...
    describe("inviting a new member", () => {
        ...
        it("should be able to input induction data", () => {
            ...
            cy.get("button").contains("預覽個人資料").click();
