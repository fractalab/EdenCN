...
EOS_READ_RPCS_URLS="${process.env.NEXT_PUBLIC_EOS_READ_RPC_URLS}"
...
DEV_USE_FIXTURE_DATA="${
    process.env.NEXT_PUBLIC_DEV_ === "false"
}"
...
export const readRpcEndpointUrls = (
    process.env.NEXT_PUBLIC_EOS_READ_RPC_URLS || ""
).split(",");
...
// DEV CONFIGS
export const devUseFixtureData =(process.env.NEXT_PUBLIC_DEV_USE_FIXTURE_DATA === "true");
